// This version does not need to be attached to an interactable object
...
/// </example>
public class VR_PanelMenuController : MonoBehaviour
{
    ...
    public bool activateWithTouchpad = true;
    ...
    {
        if (isGrabbed && activateWithTouchpad)
        {
